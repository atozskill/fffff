...
function CHOOSE(Model) {
    ...
    if (Model == "13" || Model == "13-MINI") {
        ...
        $("#PRE").attr("src", CM + "https://atozskill.github.io/gtyui/PINK.png");
        ...
        $("#PRE").attr("src", CM + "https://atozskill.github.io/gtyui/BLUE.png");
...
$("input[name='radio1']").click(function() {
    ...
    switch (this.id) {
        ...
        case "radio2":
            ...
            break;
        case "radio3":
            $("#PRE").attr("src", CM + "https://atozskill.github.io/gtyui/MIDNIGHT.png");
            CC = "Midnight";
            break;
        case "radio4":
            $("#PRE").attr("src", CM + "https://atozskill.github.io/gtyui/STARLIGHT.png");
            CC = "Starlight";
            break;
        case "radio5":
            $("#PRE").attr("src", CM + "https://atozskill.github.io/gtyui/PRODUCT-RED.png");
            CC = "(PRODUCT)RED";
            break;
    }
...
$("input[name='radio2']").click(function() {
    ...
    switch (this.id) {
        case "radio6":
            ...
            break;
        case "radio7":
            $("#PRE").attr("src", CM + "https://atozskill.github.io/gtyui/SILVER.png");
            CC = "Silver";
            break;
        case "radio8":
            $("#PRE").attr("src", CM + "https://atozskill.github.io/gtyui/GOLD.png");
            CC = "Gold";
            break;
        case "radio9":
            $("#PRE").attr("src", CM + "https://atozskill.github.io/gtyui/GRAPHITE.png");
            CC = "Graphite";
            break;
    }
